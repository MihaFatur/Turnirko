...
import { OZNAKE_STATUSA_RACUNA } from '../api/tipi'
  ...
  return (
    <section>
      <div className="naslovna-vrstica">
        <div>
          <h1>Dostopi igralcev</h1>
          <p className="podnaslov">
            Igralec se registrira sam, dostop do svojega profila pa dobi šele, ko ga
            povežeš z zapisom v šifrantu igralcev.
          </p>
        </div>
        {cakajoci.length > 0 && (
      ...
      <div className="plosca">
        ...
        {cakajoci.length === 0 ? (
          ...
          cakajoci.map((r) => <ZahtevaKartica key={r.id} racun={r} />)
        )}
      </div>
