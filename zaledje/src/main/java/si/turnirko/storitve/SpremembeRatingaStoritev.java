/* Podatki o Turnirko ratingu za prikaz ob tekmah: sprememba ("+16 / -16") in
...
@Service
public class SpremembeRatingaStoritev {

    private final RatingZgodovinaRepozitorij zgodovinaRepozitorij;
    private final RatingStanjeRepozitorij stanjeRepozitorij;

    public SpremembeRatingaStoritev(RatingZgodovinaRepozitorij zgodovinaRepozitorij,
    ...
    public Map<Long, Map<Long, ObTekmi>> zaTekme(Collection<Long> idjiTekem) {
        ...
        for (Object[] vrstica : zgodovinaRepozitorij
                .spremembeZaTekme(idjiTekem, RatingStanje.SISTEM_TURNIRKO)) {
    ...
    public Map<Long, Map<Long, Integer>> zaTekmeSrecanja(Collection<Long> idjiTekem) {
        ...
        for (Object[] vrstica : zgodovinaRepozitorij
                .spremembeZaTekmeSrecanja(idjiTekem, RatingStanje.SISTEM_TURNIRKO)) {
    ...
    /* Trenutni Turnirko rating danih igralcev (idIgralca -> rating). Za tekme, ki
    ...
    public Map<Long, Integer> trenutniRatingi(Collection<Long> idjiIgralcev) {
        ...
        for (RatingStanje stanje : stanjeRepozitorij
                .findByIgralecIdInAndSistem(List.copyOf(idjiIgralcev), RatingStanje.SISTEM_TURNIRKO)) {
